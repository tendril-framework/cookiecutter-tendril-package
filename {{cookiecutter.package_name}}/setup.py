...
setup(
    ...
    description="{{cookiecutter.package_title}}",
    long_description='\n'.join([read('README.rst'), read('CHANGELOG.rst')]),
    long_description_content_type='text/x-rst',
    keywords='tendril',
    url='https://github.com/tendril-framework/{{cookiecutter.package_name}}',
    project_urls={
        'Documentation': 'https://{{cookiecutter.package_name}}.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/{{cookiecutter.package_name}}/issues',
        'Source Repository': 'https://github.com/tendril-framework/{{cookiecutter.package_name}}',
    },
